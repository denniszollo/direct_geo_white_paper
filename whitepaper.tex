...
=======
\caption{Equipment Setup FlowChart}
...
In order to compare and analyze results from Pix4D, a total of 6 variations of settings and data were selected for rendering. As shown in Table \ref{render configurations} these configurations were identical for Piksi and Ublox. 
...
\end{tabular}
\caption{Render Configurations of Data in Pix4D}
\label{render configurations}
\end{table}
